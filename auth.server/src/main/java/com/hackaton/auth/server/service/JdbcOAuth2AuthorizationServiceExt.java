...
/**
 * @see org.springframework.security.oauth2.server.authorization.JdbcOAuth2AuthorizationService
 */
public class JdbcOAuth2AuthorizationServiceExt {
    ...
    private static Map<String, JdbcOAuth2AuthorizationServiceExt.ColumnMetadata> columnMetadataMap;
     ...
     */
    public JdbcOAuth2AuthorizationServiceExt(JdbcOperations jdbcOperations,
    ...
    public JdbcOAuth2AuthorizationServiceExt(JdbcOperations jdbcOperations,
        ...
        JdbcOAuth2AuthorizationServiceExt.OAuth2AuthorizationRowMapper authorizationRowMapper = new JdbcOAuth2AuthorizationServiceExt.OAuth2AuthorizationRowMapper(registeredClientRepository);
        authorizationRowMapper.setLobHandler(lobHandler);
        this.authorizationRowMapper = authorizationRowMapper;
        this.authorizationParametersMapper = new JdbcOAuth2AuthorizationServiceExt.OAuth2AuthorizationParametersMapper();
    ...
    private void updateAuthorization(OAuth2Authorization authorization) {
        ...
        try (LobCreator lobCreator = this.lobHandler.getLobCreator()) {
            PreparedStatementSetter pss = new JdbcOAuth2AuthorizationServiceExt.LobCreatorArgumentPreparedStatementSetter(lobCreator,
                    parameters.toArray());
    ...
    public List<OAuth2Authorization> findByPrincipalName(String principalName) {
        Assert.hasText(principalName, "principal cannot be empty");
        List<SqlParameterValue> parameters = new ArrayList<>();
        parameters.add(new SqlParameterValue(Types.VARCHAR, principalName));
        return findAllBy(PRINCIPAL_FILTER, parameters).stream().filter(Objects::nonNull).toList();
    }
    ...
    private List<OAuth2Authorization> findAllBy(String filter, List<SqlParameterValue> parameters) {
        try (LobCreator lobCreator = getLobHandler().getLobCreator()) {
            PreparedStatementSetter pss = new JdbcOAuth2AuthorizationServiceExt.LobCreatorArgumentPreparedStatementSetter(lobCreator,
                    parameters.toArray());
            return getJdbcOperations().query(LOAD_AUTHORIZATION_SQL + filter, pss, getAuthorizationRowMapper());
        }
    }
     ...
     * {@link JdbcOAuth2AuthorizationServiceExt.OAuth2AuthorizationRowMapper}.
     *
     ...
     * {@link JdbcOAuth2AuthorizationServiceExt.OAuth2AuthorizationParametersMapper}.
     *
    ...
    public static class OAuth2AuthorizationRowMapper implements RowMapper<OAuth2Authorization> {
        ...
        public OAuth2AuthorizationRowMapper(RegisteredClientRepository registeredClientRepository) {
            ...
            ClassLoader classLoader = JdbcOAuth2AuthorizationServiceExt.class.getClassLoader();
        ...
        private String getLobValue(ResultSet rs, String columnName) throws SQLException {
            ...
            JdbcOAuth2AuthorizationServiceExt.ColumnMetadata columnMetadata = columnMetadataMap.get(columnName);
    ...
    private static void initColumnMetadata(JdbcOperations jdbcOperations) {
        ...
        JdbcOAuth2AuthorizationServiceExt.ColumnMetadata columnMetadata;
    ...
    private static JdbcOAuth2AuthorizationServiceExt.ColumnMetadata getColumnMetadata(JdbcOperations jdbcOperations, String columnName, int defaultDataType) {
        ...
        return new JdbcOAuth2AuthorizationServiceExt.ColumnMetadata(columnName, dataType != null ? dataType : defaultDataType);
    }
